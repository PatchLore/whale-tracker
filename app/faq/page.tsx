...
function WhopLink() {
  const displayUrl = WHOP_STORE_URL.replace(/^https?:\/\//, "").replace(/\/$/, "");
  return (
    <a
      href={WHOP_STORE_URL}
      target="_blank"
...
const faqs = [
  {
    ...
    answer: (
      <p className="text-sm text-[var(--text2)]">
        {"Purchase your subscription at "}<WhopLink />{" \u2014 once payment is confirmed you'll be redirected to create your account"}
